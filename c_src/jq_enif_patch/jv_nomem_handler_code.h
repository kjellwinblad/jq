/*
   ...
   This file contains a copy of the code for dealing with 
   out-of-memory in jv_alloc.c

   This file is included from enif_jq_jv_alloc_replacement.c
   to make it clear what code in jv_alloc.c that is copied
   verbatrim and what has been modified.
